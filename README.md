...
| <a name="input_source_crn"></a> [source\_crn](#input\_source\_crn) | The Cloud Resource Name (CRN) of the source file share. This is mandatory for 'snapshot\_restore', 'accessor', and 'replica' modes to identify the parent or reference share. It must be null when creating a 'standard' share. | `string` | `null` | no |
