...
- A File Storage instance with VPC mode access control mode
- A Replica of the File Storage instance in another aviability zone of the File Storage instance region
